export function tr(id, locale) {
  let en = {
    ...
    Home_1: "Discover new recipes and customize them to your liking. Share with everyone to give back. Get personalised recipe suggestions.",
    ...
    Home_11: "A free recipe library",
    Home_12: "Some users share their recipes with everyone. Discover recipes from other members. Duplicate and modify their recipes easily.",
    Home_13: "Recipes are classified by categories. This way it is easy to compare similar recipes and find the one you like best as a starting point.",
  ...
  let fr = {
    ...
    n12: "Tout le monde peut maintenant voir vos recettes à l'addresse suivante:",
    ...
    Home_1: "Découvrez de nouvelles recettes et personnalisez-les à votre goût. Partagez avec tout le monde pour redonner. Reçevez des suggestions de recettes personalisées.",
    ...
    Home_12: "Certains utilisateurs partagent leur recettes avec tout le monde. Découvrez de nouvelles recettes d'autre membres. Copier, puis modifier les recettes facilement.",
    Home_13: "Les recettes sont classées par catégories. Ainsi, il est facile de comparer les recettes similaires et trouver celle qui vous convient le mieux comme point de départ.",
