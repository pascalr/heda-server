export function tr(id, locale) {
  let en = {
    ...
    Home_1: "Discover new recipes and customize them to your liking. Share with everyone if you want. Get personalised recipe suggestions.",
    Home_2: "Personalised recipes",
    Home_3: "Suggestions for you (Work in progress...)",
    Home_4: "Stop wondering what to eat. Find new recipe ideas or organize your recipes by tags to get suggestions based on your needs. For example:",
    Home_8: "Desserts",
    ...
    Home_12: "Recipes are organised by categories so you can easily compare them with similar recipes. (Ex: Chocolate chip chookies)",
  ...
  let fr = {
    ...
    Home_1: "Découvrez de nouvelles recettes et personnalisez-les à votre goût. Partagez avec tout le monde si vous le voulez. Reçevez des suggestions de recettes personalisées.",
    Home_2: "Des recettes personnalisées",
    Home_3: "Suggestions pour vous (Travail en cours...)",
    ...
    Home_13: "Trouvez la recette qui vous plait le plus et utilisez la comme point de départ. Copiez et persnnalisez!",
