      ...
      {list.map((item, current) => {
        ...
        return (
          <li key={recipe.id} className='d-flex'>
            <span>
              <img src={recipe.image_used_id ? image_variant_path({id: recipe.image_used_id}, "thumb") : "/img/default_recipe_01_thumb.png"} width="71" height="48" style={{marginRight: '0.5em'}} />
