    ...
    return (<>
      <div className="recipe">
        ...
        <div className="recipe-body">
          ...
          <h2>Instructions</h2>
          <Tiptap model={recipe} json_field="json" html_field="html" url={recipe_path(gon.recipe)} content={gon.recipe.json ? JSON.parse(gon.recipe.json) : null} editable={this.props.editable} />
